...
"function")o.onBlur($el);if($el.val()=="")$el.addClass(o.elAttrNames.hasPlaceholderClass).val(val)}$el.addClass(o.elAttrNames.elClass);blurInput();$el.off({"focus.nosui-placeholder":focusInput,"blur.nosui-placeholder":blurInput});if(disableMethod===true)return;$el.on({"focus.nosui-placeholder":focusInput,"blur.nosui-placeholder":blurInput})})},nosFormSelect:function(options,disableMethod){return this.each(function(){var defaults={elAttrNames:{typeDefault:{"defaultClass":"--default"},typeCustom:{"defaultClass":"--custom",
"dataSelected":"-selected","listClass":"__list","itemClass":"__item","activeItemClass":"__item--active","firstItemClass":"__item--first","lastItemClass":"__item--last"},"elClass":"-element","fauxElClass":"","activeClass":"--active","mousedownClass":"--mousedown","disabledClass":"--disabled","dropdownButtonClass":"__dropdown-button","placeholderClass":"__placeholder","dataName":"-type"},namespace:"nosui-form-select",defaultDropdown:false,isOpen:false,onInit:null,onClick:null,onChange:null,onMousedown:null,
onBlur:null},$el=$(this),o=NosUIApp.defineOptions(defaults,options);NosUIApp.matchElType($("select"),$el);if(disableMethod===true&&$el.data(o.elAttrNames.dataName)=="default"){$el.siblings().remove().end().removeClass(o.elAttrNames.elClass).data(o.elAttrNames.dataName,null).off({"click.nosui-form-select":null,"change.nosui-form-select":null,"blur.nosui-form-select":null}).unwrap();return}else if(disableMethod===true&&$el.data(o.elAttrNames.dataName)=="custom"){$el.removeClass(o.elAttrNames.elClass).data(o.elAttrNames.dataName,
